...
public class Token {
   ...
   *   read tokens beyond this one, this field is set to null.<br>
   ...
   *  but after the immediately preceding regular (non-special) token.<br>
   ...
   *  specialToken field, and so on until the first special token
   *  (whose specialToken field is null).<br>
   ...
   *
   * @return optional value associated with the token
   */
  ...
  /**
   * Returns a token of a given kind.
   *
   * @param ofKind token kind
   * @return new token
   */
...
/* JavaCC - OriginalChecksum=c25af6bd90294ae93dc098e3ee94404a (do not edit this line) */
