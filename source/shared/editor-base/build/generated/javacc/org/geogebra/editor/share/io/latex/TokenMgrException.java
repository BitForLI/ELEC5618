/* Generated By:JavaCC: Do not edit this line. TokenMgrException.java Version 8.1.0 */
...
public class TokenMgrException extends RuntimeException {
   ...
   * @param reason reason ordinal ({@code LEXICAL_ERROR}, {@code STATIC_LEXER_ERROR}, etc.)
   */
   ...
   * @param reason reason ordinal ({@code LEXICAL_ERROR}, {@code STATIC_LEXER_ERROR}, etc.)
   */
  public TokenMgrException(boolean eofSeen,
      int lexState, int errorLine, int errorColumn, String errorAfter, int curChar, int reason) {
    this(LexicalErr(eofSeen, lexState, errorLine, errorColumn, errorAfter, curChar), reason);
  }
  
}
/* JavaCC - OriginalChecksum=009f79b64333d68ff5b3e0199a2fca7a (do not edit this line) */
